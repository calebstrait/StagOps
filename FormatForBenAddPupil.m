function FormatForBenAddPupil(CESdata, Acls)
vmPFCdata = {};
for c = 1:156
    ...
    %**
    allcells = [25:135 141:185];
    [file,~] = ASO_CellInfo(allcells(c));
    folder = file(1:7);
    cd /Users/cstrait/Documents/Data/StagOpsPupil/
    if exist(folder, 'dir')~=0,
        eval(['cd /Users/cstrait/Documents/Data/StagOpsPupil/' folder]);
        s = what;
        if sum(ismember(s.mat,file)) == 1;
            load(file)
            d.pupilDiam = Eye;
            d.pupilDiamTS = Eye_TS;
            vmPFCdata(end+1) = {d};
        end
    end
    %**
...
save /Users/cstrait/Documents/Data/StagOpsPupil/vmPFCdataPupil.mat vmPFCdata
end
